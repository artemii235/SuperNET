...
mod tests {
    ...
    use {Builder, Error, NoopSignatureChecker, Num, Opcode, Script, ScriptWitness, Stack, TransactionInputSigner,
    ...
    fn test_arithmetic_correct_arguments_order() {
        ...
        let output: Script =
            "76009f69905160a56b210378d430274f8c5ec1321338151e9f27f4c676a008bdf8638d07c0b6be9ab35c71ad6c".into();
    ...
    fn test_script_with_forkid_signature() {
        ...
        // non-fork-id signature passed when expected
        {
            let signed_input =
                checker
                    .signer
                    .signed_input(&key_pair, 0, amount + 1, &script_pubkey, SignatureVersion::Base, 1);
            let script_sig = signed_input.script_sig.into();
    ...
    fn test_num2bin_all() {
        ...
        test_num2bin_num(0.into(), 7.into(), Ok(false), vec![
        ...
        test_num2bin_num((-42).into(), 10.into(), Ok(true), vec![
            0x2a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80,
        ]);
        test_num2bin_num(
            (-42).into(),
            520.into(),
        ...
        test_num2bin(&vec![0xab, 0xcd, 0xef, 0x42, 0x80], &vec![0x04], Ok(true), vec![
            0xab, 0xcd, 0xef, 0xc2,
        ]);
