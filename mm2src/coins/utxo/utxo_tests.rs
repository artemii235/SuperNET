...
fn utxo_coin_for_test(servers: &[&str]) -> UtxoCoin {
...
fn test_generate_transaction() {
    let coin = utxo_coin_for_test(&["test1.cipig.net:10025"]);
...
fn test_search_for_swap_tx_spend_electrum_was_spent() {
    let coin = utxo_coin_for_test(&["test1.cipig.net:10025", "test2.cipig.net:10025", "test3.cipig.net:10025"]);
